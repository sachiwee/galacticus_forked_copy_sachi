...
!+    Contributions to this file made by Sachi Weerasooriya
  ...
  !!{
  Implements an output analysis class for the \cite{kauffmann&heckmann_2009} eddington ratios.
  !!}


  !![
  <outputAnalysis name="outputAnalysisEddingtonRatioDistributionKH2009">
   <description>A \cite{kauffmanHeckmann_2009} Eddington ratio distribution output analysis class.</description>
  </outputAnalysis>
  !!]
  type, extends(outputAnalysisEddingtonRatioDistribution) :: outputAnalysisEddingtonRatioDistributionKH2009
     !!{
     A \cite{kauffmanHeckmann_2009} Eddington ratio distribution output analysis class.
     !!}
     private
     ...
     double precision                                                       :: randomErrorMinimum                        , randomErrorMaximum                  , &
          &                                                                    sizeSourceLensing
   contains
     final :: eddingtonRatioDistributionKH2009Destructor
  end type outputAnalysisEddingtonRatioDistributionKH2009

  interface outputAnalysisEddingtonRatioDistributionKH2009
     !!{
     Constructors for the \refClass{outputAnalysisEddingtonRatioDistributionKH2009} output analysis class.
     !!}
     module procedure eddingtonRatioDistributionKH2009ConstructorParameters
     module procedure eddingtonRatioDistributionKH2009ConstructorInternal
  end interface outputAnalysisEddingtonRatioDistributionKH2009

contains

  function eddingtonRatioDistributionKH2009ConstructorParameters(parameters) result (self)
    !!{
    Constructor for the \refClass{outputAnalysisEddingtonRatioDistributionKH2009} output analysis class which takes a parameter set as input.
    !!}
    use :: Input_Parameters, only : inputParameter, inputParameters
    implicit none
    type            (outputAnalysisEddingtonRatioDistributionKH2009)                              :: self
    ...
    <inputParameter>
      ...
      <description>The minimum random error for \cite{kauffmanHeckmann_2009} star formation rates.</description>
    </inputParameter>
    <inputParameter>
    ...
    <inputParameter>
      ...
      <defaultValue>[0.126d0]</defaultValue>
      <description>The coefficients of the random error polynomial for \cite{kauffmanHeckmann_2009} star formation rates.</description>
    </inputParameter>
    <inputParameter>
      ...
      <description>The coefficients of the systematic error polynomial for \cite{kauffmanHeckmann_2009} star formation rates.</description>
    </inputParameter>
    <inputParameter>
    ...
    <inputParameter>
      ...
      <description>The number of bins per decade of halo mass to use when constructing \cite{kauffmanHeckmann_2009} Eddington ratio distribution covariance matrices for main branch galaxies.</description>
    </inputParameter>
    <inputParameter>
      ...
      <description>The minimum halo mass to consider when constructing \cite{kauffmanHeckmann_2009} Eddington ratio distribution covariance matrices for main branch galaxies.</description>
    </inputParameter>
    <inputParameter>
      ...
      <description>The maximum halo mass to consider when constructing \cite{kauffmanHeckmann_2009} Eddington ratio distribution covariance matrices for main branch galaxies.</description>
    </inputParameter>
    ...
    !!]
    ! Build the object.
    self=outputAnalysisEddingtonRatioDistributionKH2009(cosmologyFunctions_,gravitationalLensing_,outputTimes_,blackHoleAccretionRate_,accretionDisks_,randomErrorMinimum,randomErrorMaximum,randomErrorPolynomialCoefficient,systematicErrorPolynomialCoefficient,covarianceBinomialBinsPerDecade,covarianceBinomialMassHaloMinimum,covarianceBinomialMassHaloMaximum,sizeSourceLensing)
    !![
    ...
    !!]
    return
  end function eddingtonRatioDistributionKH2009ConstructorParameters

  function eddingtonRatioDistributionKH2009ConstructorInternal(cosmologyFunctions_,gravitationalLensing_,outputTimes_,blackHoleAccretionRate_,accretionDisks_,randomErrorMinimum,randomErrorMaximum,randomErrorPolynomialCoefficient,systematicErrorPolynomialCoefficient,covarianceBinomialBinsPerDecade,covarianceBinomialMassHaloMinimum,covarianceBinomialMassHaloMaximum,sizeSourceLensing) result (self)
    !!{
    Constructor for the \refClass{outputAnalysisEddingtonRatioDistributionKH2009} output analysis class for internal use.
    !!}
    use :: Cosmology_Functions                   , only : cosmologyFunctionsClass                        , cosmologyFunctionsMatterLambda
    use :: Cosmology_Parameters                  , only : cosmologyParametersSimple
    use :: Galactic_Filters                      , only : galacticFilterStellarMass
    use :: Input_Paths                           , only : inputPath                                      , pathTypeDataStatic
    use :: Geometry_Surveys                      , only : surveyGeometryMagnitudeLimited
    ...
    type            (surveyGeometryMagnitudeLimited                     )               , pointer      :: surveyGeometry_
    ...
    !![
    <referenceConstruct object="surveyGeometry_"                 constructor="surveyGeometryMagnitudeLimited(redshiftMinimum=0.00208d0,redshiftMaximum=0.2d0,magnitudeApparentMinimum=14.5d0,magnitudeApparentMaximum=17.77d0,cosmologyFunctions_=cosmologyFunctions_)"/>
    !!]
    ...
    !!]
    ! Build the object.
    self%outputAnalysisEddingtonRatioDistribution=                                                                                                                                  &
         & outputAnalysisEddingtonRatioDistribution(                                                                                                                                &
         &                                         var_str('Kauffmann&Heckmann 2009'                                                                                            ), &
         &                                         var_str('Eddington ratio distribution for the Kauffmann & Heckmann 2009'                                                     ), &
         &                                         char(inputPath(pathTypeDataStatic)//'/observations/eddingtonRatioDistributions/Eddinton_Ratio_Distribution_KH2009.hdf5'     ), &
         &                                         galacticFilter_                                                                                                               , &
         &                                         surveyGeometry_                                                                                                               , &
         &                                         cosmologyFunctions_                                                                                                           , &
    ...
    return
  end function eddingtonRatioDistributionKH2009ConstructorInternal

  subroutine eddingtonRatioDistributionKH2009Destructor(self)
    !!{
    Destructor for the \refClass{outputAnalysisEddingtonRatioDistributionKH2009} output analysis class.
    !!}
    implicit none
    type(outputAnalysisEddingtonRatioDistributionKH2009), intent(inout) :: self

    !![
    <objectDestructor name="self%gravitationalLensing_"/>
    !!]
    return
  end subroutine eddingtonRatioDistributionKH2009Destructor
