...
contains
  ...
  function luminosityFunctionNIIConstructorInternal(label,comment,luminosities,depthOpticalISMCoefficient,galacticFilter_,surveyGeometry_,stellarSpectraDustAttenuation_,cosmologyFunctions_,cosmologyFunctionsData,outputAnalysisPropertyOperator_,outputAnalysisDistributionOperator_, outputTimes_,starFormationHistory_,hiiRegionLuminosityFunction_,covarianceBinomialBinsPerDecade,covarianceBinomialMassHaloMinimum,covarianceBinomialMassHaloMaximum,targetLabel,functionValueTarget,functionCovarianceTarget) result(self)
    ...
    !![
    <referenceConstruct object="nodePropertyExtractorLuminosityEmissionLine_"                           constructor="nodePropertyExtractorLuminosityEmissionLine    (cloudyTableFileName, lineNames, component, toleranceRelative,starFormationHistory_,outputTimes_,hiiRegionLuminosityFunction_           )"/>
    !!]
