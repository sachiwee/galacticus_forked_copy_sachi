...
contains
  ...
  double precision function favole2024SDSSDistanceMinimum(self,mass,magnitudeAbsolute,luminosity,field)
    !!{
  ...
  double precision function favole2024SDSSDistanceMaximum(self,mass,magnitudeAbsolute,luminosity,field)
    !!{
