...
contains
  ...
  function luminosityFunctionOIIFavole2024SDSSConstructorParameters(parameters) result (self)
    ...
    !!]
    ! Build the object.
    self=outputAnalysisLuminosityFunctionOIIFavole2024SDSS(cosmologyFunctions_,gravitationalLensing_,stellarSpectraDustAttenuation_,starFormationHistory_,outputTimes_,hiiRegionLuminosityFunction_,hiiRegionDensityDistribution_,hiiRegionEscapeFraction_,randomErrorMinimum,randomErrorMaximum,randomErrorPolynomialCoefficient,systematicErrorPolynomialCoefficient,covarianceBinomialBinsPerDecade,covarianceBinomialMassHaloMinimum,covarianceBinomialMassHaloMaximum,sizeSourceLensing,depthOpticalISMCoefficient)
    !![
  ...
  function luminosityFunctionOIIFavole2024SDSSConstructorInternal(cosmologyFunctions_,gravitationalLensing_,stellarSpectraDustAttenuation_,starFormationHistory_,outputTimes_,hiiRegionLuminosityFunction_,hiiRegionDensityDistribution_,hiiRegionEscapeFraction_,randomErrorMinimum,randomErrorMaximum,randomErrorPolynomialCoefficient,systematicErrorPolynomialCoefficient,covarianceBinomialBinsPerDecade,covarianceBinomialMassHaloMinimum,covarianceBinomialMassHaloMaximum,sizeSourceLensing,depthOpticalISMCoefficient) result (self)
    !!{
    ...
    self%outputAnalysisLuminosityFunctionOII=                                                                                                                      &
         ...
         &                                  '/central/groups/carnegie_poc/sweeraso/Galacticus_analysesNew/datasets/static/observations/luminosityFunctions/oIILuminosityFunctionFavole24SDSS.hdf5'                              , &
